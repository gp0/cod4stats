...
int main(int argc, char *argv[]) {
	...
	//write kills to stdout
	printf( "%02x", iwm.data[3479]);
	printf("%02x", iwm.data[3478]);
	printf( "%02x", iwm.data[3477]);
	printf( "%02x", iwm.data[3476]);

	printf("\n");

	//write deaths to stdout
	printf("%02x", iwm.data[3487]);
	printf( "%02x", iwm.data[3486]);
	printf("%02x", iwm.data[3485]);
	printf("%02x", iwm.data[3484]);
